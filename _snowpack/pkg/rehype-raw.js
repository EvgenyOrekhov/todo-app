...
import { f as find_1, n as normalize_1, s as spaceSeparatedTokens, c as commaSeparatedTokens, d as svg_1$1, e as html_1$1, g as convert_1, h as hastToReact, b as styleToObject, u as unistUtilVisit, a as unistUtilPosition } from './common/index-796ea957.js';
...
var html$1 = factory_1(html_1$1, 'div');
...
const html$2 = "http://www.w3.org/1999/xhtml";
...
function wrapper(ast, options) {
  ...
  return transform(ast, {
    schema: settings.space === 'svg' ? svg_1$1 : html_1$1,
    file: file,
...
function transform(ast, config) {
  ...
  if (fn === element) {
    config.schema = ast.namespaceURI === ns.svg ? svg_1$1 : html_1$1;
  }
  ...
  if (node.type === 'element') {
    ...
    if (config.verbose) {
      ...
      for (key in location.attrs) {
        props[find_1(config.schema, key).property] = position(location.attrs[key]);
      }
...
function wrapper$1(h, node, options) {
  ...
  if (root$1(node)) {
    node = node.children.length === 1 && element$1(node.children[0]) ? node.children[0] : {
      type: 'element',
      tagName: 'div',
      properties: {},
      children: node.children
...
var zwitch = factory$2;
var noop = Function.prototype;
var own$2 = {}.hasOwnProperty; // Handle values based on a property.

function factory$2(key, options) {
  var settings = options || {};
...
function transform$1(tree, space) {
  return one(tree, space === 'svg' ? svg_1$1 : html_1$1);
}
...
function wrap(tree, file, options) {
  ...
  if (stitches) {
    unistUtilVisit(result, 'comment', mend);
